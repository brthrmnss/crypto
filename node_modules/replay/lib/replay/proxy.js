...
ProxyRequest = (function(_super) {
  ...
  function ProxyRequest(options, replay, proxy) {
    ...
    if (options.headers) {
      ...
      for (n in _ref1) {
        v = _ref1[n];
        this.headers[n.toLowerCase()] = v && v.toString ? v.toString() : "";
      }
    }
      ...
      console.log('\n\n\n\n')
      console.log('testing request', this.url)
      var c = {}
      c.pfx = options.pfx
      options.pfx=null
      console.log(JSON.stringify(options,null, tab))
      ...
      console.log(JSON.stringify(this,null, tab))
      this.replay = clone.replay;
      console.log('\n\n\n\n')
