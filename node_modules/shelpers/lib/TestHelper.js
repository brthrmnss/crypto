...
function defineUtilsX(){
    ...
    function reqPost2(opts) {
        ...
        reqoptions.timeout = reqoptions.urlTimeout;
        var req = localRequest(reqoptions, function onLocalRequestResponse(error, response, body) {
            ...
            if ( response == null ) {
                console.error('TestHelper- response is null', url);
            } else {
                if (response.statusCode == '404') {
                    console.error('th- 404 for ', opts.name, body)
                }
                if (response.statusCode == '500') {
                    console.error('th- 500 for ', opts.name, body)
                }
            ...
            if ( opts.fx2 != null ) opts.fx2(body, response, error)
