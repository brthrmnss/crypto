...
function defineFS() {
    ...
    sh.fs.isFileOrderThanAgoMS = function isFileOrderThanAgoMS(filename, compareToTime) {
...
function defineJSON() {
    ...
    sh.json.good = function makeErrorJSON(msg) {
        /*  if ( value === undefined ) {
         value = name;
         name = 'value';
         }
...
function makePathIfDoesNotExist(dir, notNotCleanUpName) {
    var fs = require("fs")
...
function copyProps(from, to, filterItems) {
