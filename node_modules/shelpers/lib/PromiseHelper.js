...
function PromiseHelper() {
    ...
    self.data = {}
    if ( PromiseHelper.id == null ) {
        PromiseHelper.id = 0;
    }
    PromiseHelper.id++
    self.data.id = PromiseHelper.id
    ...
    self.wrapMethod = function wrapMethod(fx) {
        ...
        var wrapperFx = function autoGenWrapper(token) {
            ...
            function temp(token, resolve) {
                if ( self.data.stop ) {
                    console.error('this promsiehelper was stopped', self.data.id)
                    return;
                }
...
//                asdf.g
                if ( self.data.stop ) {
                    console.error('promise helper stopped', self.data.id)
                    return;
                }
