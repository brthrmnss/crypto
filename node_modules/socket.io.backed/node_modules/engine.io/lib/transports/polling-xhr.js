...
XHR.prototype.headers = function(req, headers){
  ...
  var _setHeaders = false;
  _setHeaders = true;
  if ( _setHeaders != false ) {
  if (req.headers.origin) {
    headers['Access-Control-Allow-Credentials'] = 'true';
    headers['Access-Control-Allow-Origin'] = req.headers.origin;
  } else {
    if (req.headers.host) {
      console.error('mixed', req.headers)
      //asdf.g
      headers['Access-Control-Allow-Credentials'] = 'true';
      headers['Access-Control-Allow-Origin'] = req.headers.host;
      headers['Access-Control-Allow-Origin'] = 'boosmdf$#$%'
    } else {
