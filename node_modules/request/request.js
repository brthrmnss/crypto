...
Request.prototype.onResponse = function (response) {
  ...
  debug('onResponse', self.uri.href, response.statusCode, response.headers)
   response.setMaxListeners(0); //asdf ?? place this here
    response.connection.setMaxListeners(0); //asdf ?? place this here
  ...
  var addCookie = function (cookie) {
    ...
    try {
      ...
      //asdf bookmark.ignore cookie errors
      var ignoreCookieErrors = false
      ignoreCookieErrors = true
      if ( ignoreCookieErrors ) {
       console.error('warning ... ignoring a cookie error on', cookie, e)
      } else {
        self.emit('error', e);
      }
    }
