	...
	if( n & 1 ){
		...
		if( n & 2 ){
			...
			if( n & 4 ){
                ...
                var val = this.readValue(amf.AMF3)
                console.log(Traits.clss,val, Obj)
                Obj['source'] = val

                //prop = this.readUTF8( amf.AMF3 );
                //console.log(Traits.clss,this.readArray(amf.AMF3))
               /* while( prop = this.readValue( amf.AMF3 ) ){
                    Obj = prop;
                   // console.log('-',Traits.clss,prop, Obj)
                }*/
                //console.log(Obj)
