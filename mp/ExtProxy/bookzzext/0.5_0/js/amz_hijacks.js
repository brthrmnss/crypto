...
function ChromeExtMod() {
    ...
    p.procEbookz = function procEbookz() {
        console.log('procEbookz', true !=  window.jQuery)
        console.log('ListExtractorScraper', ListExtractorScraper)
    }
...
if ( window.what == null && true == false  ) {
    window.what = true
