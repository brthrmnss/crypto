...
//adf.g
    ...
    // xyzRotation += "rotateX("+rotsZ[0]+"deg) ";
    ...
    function addDiv(){
        ...
        innerTransformContainer.append('<img src="arrow2.png" style=" position:absolute; top:0px; '+
            'transform: '+xyzRotation+'" />');
        innerTransformContainer.append('77777777');


        function getSizeOfAnnotation(){
            //100px is how many feet?

            var realWorldWidthOfAnnotation = 6/12; //1/2 ft

            var widthOfAnnotation = cW;


            var realWorldWidthOfTAnnotation = 0
            realWorldWidthOfTAnnotation = 3; //ft

            var pixelWidthOfTargetAnnotation = 0 ;


            pixelWidthOfTargetAnnotation = (realWorldWidthOfTAnnotation/realWorldWidthOfAnnotation)*widthOfAnnotation
        ...
        var u = x({title:'dog'})
        innerTransformContainer.append(u);
