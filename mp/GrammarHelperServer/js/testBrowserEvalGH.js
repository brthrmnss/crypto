...
(function() {
    ...
    function loadManifest($) {
        ...
        baseBaseUrlConnect = baseBaseUrl
        if ( window.location.href.includes('192.168.1')  ) {
            var baseBaseUrl = 'http://'+window.location.host
            baseBaseUrlConnect = baseBaseUrl
            if ( window.location.port != 80) {
                baseBaseUrlConnect = baseBaseUrlConnect.replace(window.location.port, '14002')
                14002
            } else {
                baseBaseUrlConnect += ':'+14002
            }
            baseBaseUrl = baseBaseUrl + '/'+'g/js/libHide/'
