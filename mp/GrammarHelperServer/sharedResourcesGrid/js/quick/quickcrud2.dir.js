    ...
    var quickCrud2Controller2 =
        function quickCrud2Controller2($scope,
            ...
            $scope.render = function render(tH2, attrs, element) {
                ...
                config.fxExternalSelectItem = function fxExternalSelectItem(newItem) {
                    //console.info('ok ok ok ', newItem)
                    $scope.onSelectListItem(newItem);
                    //debugger
                    /* if ( newItem != null ) {
                            config.dataObject = newItem;
                            $scope.dataObject = newItem;
                ...
                console.log('quickCrud2', config)
                if (config && config.types != null && config.init != null) {

                    sh.throw('messedup config')
                }
            ...
            $scope.onSelectListItem = function onSelectListItem(item) {
                ...
                sh.cid($scope.vm.config.quickFormConfig.fxChangeDataObject, item)
            };
