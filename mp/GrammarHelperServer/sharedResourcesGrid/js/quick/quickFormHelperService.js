'use strict';
/**
 * Helper provides utilities to quickly define forms
 */
( function() {
  //console.error('.d..,')
  // var quickFormHelperService = function quickFormHelperService( sh, pubSub ) {
  function QuickFormHelper( sh, pubSub ) {
    var self = this;
    var p = this;
    ...
    function defineElements() {
      ...
      p.addSelectList_FromObj = function addSelectList_FromObj(
          name, objectKV, label, defaultValue
      ) {
  ...
  //QuickFormHelper.$inject = ['sh', 'pubSub'];
  if ( window.reloadableHelper ) {
    // debugger;
    var wrapperRelodableService = window.reloadableHelper
        .makeServiceReloadable('QuickFormHelper', QuickFormHelper);
    ...
    debugger;
    angular.module('com.sync.quick').factory('quickFormHelper', QuickFormHelper );
    angular.module('com.sync.quick').factory('qFH', QuickFormHelper );
  }
  // debugger
