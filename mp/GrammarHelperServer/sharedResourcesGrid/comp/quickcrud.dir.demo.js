...
(function(){
  ...
  var quickCrudDemo = function quickCrudDemo($templateRequest,
    ...
    return {
      ...
      controller: 'QuickCrudDemoController2',
      controllerAs: 'vm',
  ...
  app.directive('quickCrudDemo2', quickCrudDemo);

  var QuickCrudDemoController2 =
    function QuickCrudDemoController2 ($scope,
                                      dialogService,
                                      dataGen,
                                      $restHelper,
                                      appAreaService,
...
//o.fxSave(function () {
  ...
  app
    .controller('QuickCrudDemoController2', QuickCrudDemoController2);
  app
