  ...
  var QuickCrudDemoController =
      function QuickCrudDemoController ($scope,
        ...
        function createListOfPrompts() {
          ...
          $scope.appArea = appAreaService.createAARouter(viewConfig.appArea);
        ...
        function createSomethingCrud4() {
          ...
          qC4.viewAARouter = appAreaService.createAAReceiver(viewConfig.appArea,
        ...
        function createLogList(){
          ...
          qCrudCreateLog.viewAARouter = appAreaService.createAAReceiver(viewConfig.appArea,
