...
(function(){
  ...
  var reload_name = 'quickCrudExplorerDemo'
    ...
    $scope.render = function render( utils ) {
      ...
      scope.generateFormConfig = function generateFormConfig() {
       ...
       // quickFormHelper.loadConfig(cfg)
        ...
        quickFormHelper.addButton('Change', function onReRender() {
          console.info('hit')
          cfgCrud.fxReRender()
        }  )
     ...
     //    scope.vm.listData = x.items;
        ...
        h.quickFormHelper.addTextInput('name', 'what your name?')
        h.showFilter(true)
        /*
         h.listItems =
         h.listitemsBindable(asdf)
