REM start "grammarhelperlite" node G:\Dropbox\projects\crypto\mp\GrammarHelperServer\GrammarHelperServerLite.js
REM start "grammarhelper" node G:\Dropbox\projects\crypto\mp\Proxy2\YoutubeServer.js
REM start "auotit server" node G:\Dropbox\projects\crypto\mp\AutoItKey\AutoItServer.js

REM start "pidserver" node G:\Dropbox\projects\crypto\mp\BabylonJS\PIDServer.js


start "pdf server.js" node G:\Dropbox\projects\delegation\Reader\TTS-Reader\Server.js
REM start "pdf server.js" /D  "G:\Dropbox\projects\delegation\Reader\TTS-Reader" node G:\Dropbox\projects\delegation\Reader\TTS-Reader\Server.js
