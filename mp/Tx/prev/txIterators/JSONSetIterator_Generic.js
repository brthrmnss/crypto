...
function JSONSetIterator_Generic() {
    ...
    self.isAmz = function isAmz() {
        ...
        var addItem = false
        if (self.settings.it.itemsSkip) {
            addItem = true;
           // console.log('what is it', self.item)
    ...
    p.fxDone = function onDone() {
        ...
        if ( self.utils2 == null ) {
           // console.log(self.utils2, 'ok', self)
         //   console.error(self.utils2, 'ok' )
        }

        var percentage = self.runner.utils2.percentageOfWorkList(self.data.matches, self.name)
        var sum = self.runner.utils2.sumArray(self.data.matches, 'amount', self.name)
        ...
        //console.log('what is name-----', self.name)
        ...
        if (listAllItemsCount) {
            ...
            percentage = self.runner.utils2.percentageOfWorkList(self.data.matches, self.name, self.settings.listAllItemsCount)
            //xyx += 'd'
            // sdfg.h
        }
